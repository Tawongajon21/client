            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  <div class="chart tab-pane" id="sales-chart" style={{position: "relative", height: 300+'px'}}>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <img 
                    class="direct-chat-img" src="dist/img/user3-128x128.jpg"
            ...
            <div class="card bg-gradient-info">
              ...
              <div class="card-body">
                <canvas class="chart" id="line-chart"
                 style={{"minHeight": 250+"px", height: 250+"px", maxHeight: 250+"px", maxWidth: `100%`}}>
